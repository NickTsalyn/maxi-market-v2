...
export const MOCK_PRODUCT_CARDS: ProductCard[] = [
  {
    description:
      'Рюкзак "Експлорер" - ідеальний спутник для активного стилю життя та пригод...',
    imgUrl:
  ...
  {
    description:
      "Відкладаєте важливі й дрібні справи на завтра, на потім, на останній тиждень перед дедлайном? ",
    imgUrl:
  ...
  {
    description:
      "Електронний конструктор Znatok Перші кроки в електроніці (набір В) - прекрасний подарунок.",
    imgUrl:
  ...
  {
    description:
      "Кабель USB Samsung Galaxy Tab P1000 P3100 P3110 P5100 P5110 N8000 P7500 Original коробка",
    imgUrl:
  ...
  {
    description:
      "Набір гантелі 2шт вагою по 16кг ідеально підходить для тих, хто прагне зміцнити своє тіло.",
    imgUrl:
...
export const MOCK_FILTER_CARDS: ProductCardFilter[] = [
  ...
  {
    description:
      "Огляд Велосипед CrossBike 26`` Spark D-Steel 2023 Рама 13`` neon yellow. Технічні параметри:",
    imgUrl:
  ...
  {
    description:
      "Naturehike P-Series 2 виконано в ультралегкому стилі. Для цього виробник використовує одні з ...",
    imgUrl:
  ...
  {
    description:
      "Ліхтар виконаний у міцному пластиковому корпусі типу АВС. 1 яскравий діод LED із дальністю ",
    imgUrl:
...
export const MOCK_PRODUCT_COLORS = [
  { value: "чорний", label: "Чорний", color: 'black' },
  { value: "білий", label: "Білий", color: 'white'},
  { value: "синій", label: "Синій", color: 'blue' },
  { value: "зелений", label: "Зелений", color: 'green'},
  { value: "червоний", label: "Червоний", color: 'red' },
  { value: "сірий", label: "Сірий",color: 'gray' },  
  { value: "інше", label: "Інше", color: '#E7E9FC' },
];
